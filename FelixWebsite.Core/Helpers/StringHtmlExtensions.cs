...
namespace FelixWebsite.Core.Helpers
{
    ...
    public static class StringHtmlExtensions
    {
        ...
        /// <summary>
        /// Replaces the inputString with FelixResources.general_empty_field if the inputString is empty
        /// </summary>
        /// <param name="inputString">The string to present</param>
        /// <returns></returns>
        public static string GetPresentableString(string inputString)
        {
            return string.IsNullOrEmpty(inputString) ? FelixResources.general_empty_field : inputString;
        }
    }
}
