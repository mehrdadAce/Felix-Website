...
namespace FelixWebsite.Core.App_Plugins.AcquisitionTool
{
    [PluginController(Constants.ACQUISITION_TOOL_NAME)]
    [Tree(Constants.ACQUISITION_TOOL_ALIAS, Constants.ACQUISITION_TOOL_TREE_ALIAS, Constants.ACQUISITION_TOOL_TREE_NAME)]
    public class AcquisitionToolTreeController : TreeController
    {
        ...
        protected override TreeNodeCollection GetTreeNodes(string id, FormDataCollection queryStrings)
        {
            ...
            {
                var list = acquisitionInformationService.GetAllCompletedAcquisition();
            ...
            try
            {
                ...
                foreach (var acquisition in sortedAcquisitionList)
                {
                    ...
                    var node = CreateTreeNode(yearId, parentId, queryStrings, year + string.Empty, "icon-calendar-alt",
                        true,
                        "/" + Constants.ACQUISITION_TOOL_ALIAS + "/" + Constants.ACQUISITION_TOOL_TREE_ALIAS +
