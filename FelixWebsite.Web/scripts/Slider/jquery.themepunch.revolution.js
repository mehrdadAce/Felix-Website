...
(function(jQuery,undefined){
	...
	///////////////////////////////////////
    const overlayColor = 'rgba(49, 49, 49, 0.56)';
		...
		*******************************************************/
		...
		var prepareSlides = function(container,opt) {
			...
			container.find('>ul:first >li >img').each(function(j) {
                ...
                // JM
                img.replaceWith(
                    '<div class="tp-bgimg defaultimg" data-lazyload="' + img.data('lazyload') +
                    '" data-bgfit="' + bgfit +
                    '"data-bgposition="' + bgposition +
                    '" data-bgrepeat="' + bgrepeat +
                    '" data-lazydone="' + img.data('lazydone') +
                    '" data-src="' + "#" +
                    '" src="' + src +
                    '" style="background-color:' + img.css("backgroundColor") +
                    ';background-repeat:' + bgrepeat +
                    // Show dark overlay.
                    ';background:linear-gradient(0deg,' + overlayColor + ',' + overlayColor +'), url(' + src + ');' +
